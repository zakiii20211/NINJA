...
NC='\e[0m'
#IZIN SCRIPT
IZIN=$(curl https://raw.githubusercontent.com/zakiii20211/allow/main/ipvps.conf | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
Name=$(curl https://raw.githubusercontent.com/zakiii20211/allow/main/ipvps.conf | grep $MYIP | awk '{print $2}')
