#!/bin/bash
# Installer for Python Proxy Mod by KhaiVPN – Debian 13
...
RESPONSE = (
    'HTTP/1.1 101 <b><u><font color="purple">(HTTP) Script By KhaiVPN</font></b>\r\n'
...
[Unit]
Description=Python Proxy Mod By KhaiVPN
