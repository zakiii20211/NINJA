...
IZIN=$(curl https://raw.githubusercontent.com/zakiii20211/izinsc/main/ip | grep $pass | awk '{print $2}')
if [ $pass = $IZIN ]; then
    echo -e ""
...
#Welcome Note
echo -e "============================================="
echo -e " ${green} WELCOME TO KhaiVPN PREMIUM SCRIPT${NC}"
echo -e "============================================="
echo -e ""
sleep 4
clear
...
echo -e "============================================="
sleep 2
wget ${websc}/script/monthly/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
sleep 2
clear
...
echo " "
echo "====================== KhaiVPN AUTOSCRIPT =======================" | tee -a log-install.txt
